...
def load_model_and_dataset(checkpt_filename):
    ...
    if hasattr(args, 'ncon'):
        ...
        vae = vae_quant.VAE(
            z_dim=args.latent_dim, beta=args.beta, use_cuda=True, prior_dist=prior_dist, q_dist=q_dist, x_dist_name=args.x_dist, include_mutinfo=not args.exclude_mutinfo, 
